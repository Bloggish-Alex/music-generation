#!/usr/bin/env python3
"""Configuration loading helpers for the HMM experiment package."""
...
class ConfigLoader:
    """Load default style config plus optional YAML overrides."""
...
class ConfigView:
    """Small accessor wrapper so modules do not hard-code nested defaults."""
