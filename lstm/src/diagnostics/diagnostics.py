...
class TrainingDiagnostics(DiagnosticsBase):
    """Training diagnostics focused on data quality and learned symbols."""
    ...
    def record_encoder(self, diagnostics: Dict[str, Any]) -> None:
        self.record_stage("encoder", diagnostics)
